...
def fetch_data(jql):
    ...
    if EM and TK:
        try:
            ...
            # FIX: Changed to search_issues and maxResults=5000
            for i in j.search_issues(jql, maxResults=5000, fields=','.join(flds)):
                r = i.raw['fields']
...
def load_live():
    # FIX: Updated to -60d to bridge the missing date gap
